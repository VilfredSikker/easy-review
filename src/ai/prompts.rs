...
1. Run: `git diff {diff_args} > .er/diff-tmp && shasum -a 256 .er/diff-tmp`
...
pub fn build_questions_prompt(base_branch: &str) -> String {
    format!(
...
2. Run: `git diff {base_branch} --unified=3 --no-color --no-ext-diff > .er/diff-tmp`
