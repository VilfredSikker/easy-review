...
- **`er-review` agent skill** — install via `er install-skills`, `npx skills add VilfredSikker/easy-review -s er-review`, or `gh skill install` so agents can run “ER review” end-to-end. Source: `skills/er-review/SKILL.md`.
