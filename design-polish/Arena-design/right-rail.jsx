...
function RightRail({ mode, branch, ai, questions, density, terminalInRight, onTab, activeTab, onAskAI, collapsed, onExpand, reviewPickerMode, reviewState, onOpenArena, onNewRun }) {
  if (collapsed) {
    return <RailCollapsed branch={branch} ai={ai} questions={questions} onExpand={onExpand} onTab={onTab} />;
  }
  if (mode === 'tabs') {
    return <RailTabs branch={branch} ai={ai} questions={questions} activeTab={activeTab} onTab={onTab} onAskAI={onAskAI} terminalInRight={terminalInRight} reviewPickerMode={reviewPickerMode} reviewState={reviewState} onOpenArena={onOpenArena} onNewRun={onNewRun} />;
  }
  if (mode === 'accordion') {
    return <RailAccordion branch={branch} ai={ai} questions={questions} onAskAI={onAskAI} terminalInRight={terminalInRight} reviewPickerMode={reviewPickerMode} reviewState={reviewState} onOpenArena={onOpenArena} onNewRun={onNewRun} />;
  }
  return <RailStacked branch={branch} ai={ai} questions={questions} onAskAI={onAskAI} reviewPickerMode={reviewPickerMode} reviewState={reviewState} onOpenArena={onOpenArena} onNewRun={onNewRun} />;
}
...
// ────────────────────────────────────────────────────────────────────────────
function RailTabs({ branch, ai, questions, activeTab, onTab, onAskAI, terminalInRight, reviewPickerMode, reviewState, onOpenArena, onNewRun }) {
  const tabs = [
  ...
  return (
    <aside style={railStyle}>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        ...
        {activeTab === 'review'   && <div style={{ padding: 14 }}><ReviewMulti pickerMode={reviewPickerMode} reviewState={reviewState} onOpenArena={onOpenArena} onNewRun={onNewRun} /></div>}
...
// ────────────────────────────────────────────────────────────────────────────
function RailStacked({ branch, ai, questions, onAskAI, reviewPickerMode, reviewState, onOpenArena, onNewRun }) {
  return (
    <aside style={railStyle}>
      <div style={{ flex: 1, overflowY: 'auto' }}>
        ...
        <Section label="AI Review" icon="ph-sparkle" badge="fresh" defaultOpen>
          <ReviewMulti pickerMode={reviewPickerMode} reviewState={reviewState} onOpenArena={onOpenArena} onNewRun={onNewRun} />
        </Section>
...
// ────────────────────────────────────────────────────────────────────────────
function RailAccordion({ branch, ai, questions, onAskAI, reviewPickerMode, reviewState, onOpenArena, onNewRun }) {
