...
pub use diff::{
    ...
    filter_raw_diff_exclude_globs, header_to_stub, parse_diff, parse_diff_headers,
    parse_file_at_offset, refetch_file_with_context, CompactionConfig, DiffFile, DiffFileHeader,
    DiffHunk, DiffLine, LineType,
};
pub use status::{
