...
pub const INBOX_KIND_CATALOG: &[InboxKindMeta] = &[
    ...
    InboxKindMeta {
        key: "pr_review_received",
        label: "Review received",
        show_description: "Show when someone leaves a review on your PR",
        notify_description: "Notify when someone leaves a review on your PR",
    },
    InboxKindMeta {
        key: "pr_comment",
        label: "Comment on your PR",
        show_description: "Show when someone comments on your PR",
        notify_description: "Notify when someone comments on your PR",
    },
    InboxKindMeta {
        key: "pr_comment_reply",
        label: "Reply on comment",
        show_description: "Show when someone replies on a comment",
        notify_description: "Notify when someone replies on a comment",
    },
    InboxKindMeta {
        key: "mention",
        label: "Mention",
        show_description: "Show when you are mentioned on a PR",
        notify_description: "Notify when you are mentioned on a PR",
    },
    InboxKindMeta {
        key: "ci_failed",
        label: "CI failed",
...
fn canonicalize_inbox_kind(kind: &str) -> Option<&'static str> {
    Some(match kind {
        ...
        "pr_comment_reply" => "pr_comment_reply",
        "mention" => "mention",
        "ci_failed" => "ci_failed",
        "pr_merged" => "pr_merged",
        "pr_closed" => "pr_closed",
